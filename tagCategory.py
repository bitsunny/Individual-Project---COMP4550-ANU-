...
os.environ['JAVAHOME'] = '/Library/Java/JavaVirtualMachines/jdk1.8.0_131.jdk/Contents/Home'
os.environ['CLASSPATH'] = '/Users/songshuaichen/Downloads/jars/stanford-postagger.jar'
import string
...
def preprocess(inputFile, outputFile, outputFile_processed):
    ...
    removeList = ["Questions", "Question", "For questions", "for questions", "This tag", "this tag", "THIS TAG",
                  "For issues", "for issues"]  # "Use this tag", "DO NOT", "This is a tag"}
    ...
    conjunctionList = [" set of", " sets of", " collection of", " collections of", " part of", " parts of", " type of",
                       " types of", " version of", " versions of", " group of", " groups of", " kind of ", " kinds of ",
                       " form of ", " forms of ", " piece of ", " pieces of ", " sequence of ",
                       " iteration of the"]  # conjuction list
...
def extractSVO(inputFile_data, inputFile_pos, outputFile_svo, outputFile_exception):
    ...
    english_postagger = StanfordPOSTagger(
        '/Users/songshuaichen/Downloads/stanford-postagger-full-2016-10-31/models/english-bidirectional-distsim.tagger')
    ...
    for index, row in enumerate(lines):
        ...
        if svo == "":
            ...
            fw_svo.write(items[0] + "	" + svo.encode("utf-8") + "|" + svo2.encode("utf-8") + "	" + text.encode(
                "utf-8") + "\n")
...
def furtherPostProcess(inputFile, outputFileLong, outputFile):
    ...
    transformDic = {"tools": "tool", "libraries": "library", "functions": "function", "extensions": "extension",
                    "bindings": "binding", "classes": "class", "systems": "system"}
